...
#### version 5 ####
###################
# the number of transformed categories = 0,
# to compare with human data from Vision Research
...
def parse_args():
    ...
    parser.add_argument('-v', '--version', default=5, type=int, help='experiment version')
        ...
        def compute_loss(labels, outputs):
            if args.model_name == 'blnet-3' or args.model_name == 'blnet-5':
                ...
                for output in outputs:
                    per_example_loss += loss_func(labels, output)
                per_example_loss = per_example_loss / len(outputs)
            else:
...
if __name__ == '__main__':
    ...
    if args.is_slurm == True:
        ...
        args.model_format = [
            #### blur
            # 'alexnet_scratch_none_discrete_0_0_1_discrete_0',
            # 'vgg19_scratch_none_discrete_0_0_1_discrete_0',
            # 'resnet50_scratch_none_discrete_0_0_1_discrete_0',
            'vitb16_scratch_none_discrete_0_0_1_discrete_0',
            # 'vitb16_pretrained_none_discrete_0_0_1_discrete_0',
        ][args.id-1]
        ...
        args.model_format = 'alexnet_scratch_none_discrete_0_0_1_discrete_0'
        # args.model_format = 'vgg19_scratch_none_discrete_0_0_1_discrete_0'
        # args.model_format = 'resnet50_scratch_none_discrete_0_0_1_discrete_0'
        # args.model_format = 'vitb16_pretrained_none_discrete_0_0_1_discrete_0'
