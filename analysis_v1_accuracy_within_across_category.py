...
def parse_args():
    ...
    parser.add_argument('-i', '--id', default=2, type=int, help='slurm array task id')
...
def main(args):
    ...
    for idx, param in enumerate(params):
        ...
        accuracy1_within[idx] = accuracy1_within_
        accuracy1_across[idx] = accuracy1_across_
    ...
    with open(os.path.join(args.model_path, 'analysis_v1_accuracy_within_across_category.pickle'), 'wb') as f:
        pickle.dump(data, f)
