...
def main_torch(args):
    ...
    with open(os.path.join(args.model_path, 'analysis_v3_accuracy_by_rotate.pickle'), 'wb') as f:
        pickle.dump(data, f)
...
if __name__ == '__main__':
    ...
    if args.is_slurm == True:
        ...
        args.model_format = 'alexnet_rotate_continuous_0-360_350_1_discrete_0'
