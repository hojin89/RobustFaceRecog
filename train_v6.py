...
from models.convlstm_tf import ConvLSTM3, ConvLSTM3v2, ConvLSTM3v3

def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('-v', '--version', default=6, type=int, help='experiment version')
...
def main_tf(args):
    ...
    with strategy.scope():
        ...
        elif args.model_name == 'convlstm3v2-1':
            model = ConvLSTM3v2(input_size=input_size, num_classes=num_categories, num_timesteps=1)
            _ = model(tf.zeros((1,) + input_size))
        elif args.model_name == 'convlstm3v2-3':
            model = ConvLSTM3v2(input_size=input_size, num_classes=num_categories, num_timesteps=3)
            _ = model(tf.zeros((1,) + input_size))
        elif args.model_name == 'convlstm3v2-5':
            model = ConvLSTM3v2(input_size=input_size, num_classes=num_categories, num_timesteps=5)
            _ = model(tf.zeros((1,) + input_size))
        elif args.model_name == 'convlstm3v3-1':
            model = ConvLSTM3v3(input_size=input_size, num_classes=num_categories, num_timesteps=1)
            _ = model(tf.zeros((1,) + input_size))
        elif args.model_name == 'convlstm3v3-3':
            model = ConvLSTM3v3(input_size=input_size, num_classes=num_categories, num_timesteps=3)
            _ = model(tf.zeros((1,) + input_size))
        elif args.model_name == 'convlstm3v3-5':
            model = ConvLSTM3v3(input_size=input_size, num_classes=num_categories, num_timesteps=5)
            _ = model(tf.zeros((1,) + input_size))
        model.summary()
...
if __name__ == '__main__':
    ...
    if args.is_slurm == True:
        ...
        args.model_format = [
            ...
            'convlstm3v2-1_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
            'convlstm3v2-3_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
            'convlstm3v2-5_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
            'convlstm3v3-1_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
            'convlstm3v3-3_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
            'convlstm3v3-5_scratch_rotate_discrete_0-45-90-135-180-225-270-315_300_1_discrete_0',
        ][args.id-1]
    ...
    if args.model_name in ['alexnet', 'vgg19', 'resnet50', 'cornets-1', 'cornets-3', 'cornets-5', 'vitb16']:
        main_torch(args)
    elif args.model_name in ['convlstm3-1', 'convlstm3-3', 'convlstm3-5', 'convlstm3v2-1', 'convlstm3v2-3', 'convlstm3v2-5', 'convlstm3v3-1', 'convlstm3v3-3', 'convlstm3v3-5']:
        main_tf(args)
    else:
