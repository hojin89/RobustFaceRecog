...
def parse_args():
    ...
    parser.add_argument('-j', '--job', default='', type=str, help='slurm job id')
...
if __name__ == '__main__':
    ...
    if args.is_slurm == True:
        args.model_format = [
            'alexnet_rotate_continuous_1-0.1_1_1_discrete_0',
        ][args.id-1]
        ...
        args.model_format = 'convlstm3_none_continuous_0-145_388_1_continuous_0-0.5'
    ...
    #### create model folder & write slurm job id
    os.makedirs(args.model_path, exist_ok=True)
    if args.is_slurm == True:
        open(os.path.join(args.model_path, 'slurm_job_id.txt'), 'a+').write(args.job + '\n')
